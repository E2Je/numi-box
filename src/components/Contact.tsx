...
export const Contact = () => {
  return <section id="contact" className="section-padding bg-cream relative overflow-hidden">
      {/* Decorative Flowers */}
      <img src={flowers1} alt="" className="absolute top-0 left-0 w-48 md:w-64 opacity-20 pointer-events-none" aria-hidden="true" />
      <img src={flowers1} alt="" className="absolute bottom-0 right-0 w-48 md:w-64 opacity-20 pointer-events-none rotate-180" aria-hidden="true" />
