...
export const Story = () => {
  ...
  return <section id="story" className="section-padding bg-lavender-soft/30">
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          delay: 0.2
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                כמורה ליוגה, במהלך השנים, ראיתי שוב ושוב איך בסיום כל שיעור דווקא הרגעים השקטים, המדיטציה, הנשימות, כרית העיניים הרכה וריח הלבנדר באוויר, הם אלה שהאנשים הכי מחכים להם.
              </p>
              <p>
